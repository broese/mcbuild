...
hud_help_text HUD_HELP[] = {
    ...
    { "bu_common",  "Common usage of build commands:\n"
                    "#build <command> <parameters>  \n"
                    "  <command> - single word, see \n"
                    "  descr. in other sections     \n"
                    "  <parameters> - specific for  \n"
                    "  each command, examples:      \n"
                    "#build floor 10,6 iron_block   \n"
                    "#build replace grass dirt      \n"
                    "#build place 1000,2000,70,north\n"
                    "#build hollow -f               \n"
                    "#build trim y<10 x>=0          \n"
                    "\n"
                    "Some notations:                \n"
                    ...
                    "W[,H]   - either width,height, \n"
                    " or just width (height is opt.)\n"
                    "-f      - flag-like parameters \n" },

    { "bu_mat",     "How to specify materials?      \n"
                    "Some commands take it as para- \n"
                    "meter, often optional.         \n"
                    "If omitted - then block you are\n"
                    "currently holding is used.     \n"
                    "\n"
                    "symbolic name: e.g. brick_block\n"
                    "- same as standard MC commands.\n"
                    "\n"
                    "or numeric ID - decimal or hex:\n"
                    "42 or 0x2a - both mean iron bl.\n"
                    "\n"
                    "submaterials/types, e.g. :     \n"
                    "wool:red or sandstone:smooth   \n"
                    "\n"
                    "placement of slabs (u/d):      \n"
                    "stone_slab:sandstone:u         \n"
                    "\n"
                    "See docs for more examples     \n" },


    { "bu_par",     "Create parametric builds\n"
                    "#build <type> [options/params] \n"
                    "Select with '#hud help <type>':\n"
                    "floor                          \n"
                    "rect                           \n"
                    "disk                           \n"
                    "ring                           \n"
                    ...
                    "scaffolding                    \n"
                    "\n"
                    "All commands create a buildplan\n"
                    "that you then can place.       \n" },
    { "floor"       "Flat rectangular floor         \n"
                    "#build floor W[,L] [<mat>]     \n"
                    "\n"
                    "#bu fl 10,5 stone              \n"
                    "  10 wide, 5 deep, stone blocks\n"
                    "\n"
                    "#bu fl 10 dirt                 \n"
                    "  10x10 dirt blocks            \n"
                    "\n"
                    "#bu fl 30,20                   \n"
                    "  30x20 floor made of whatever \n"
                    "  block you are holding        \n"
                    "\n"
                    "#bu fl 4,64 wheat              \n"
                    "  4-wide 64-long patch of wheat\n"
                    "  yes you can use it for       \n"
                    "  planting crops as well!      \n"
                    "Pivot point is left near corner\n" },

    { "rect"        "Horizontal rectangle - just    \n"
                    "like floor, but border only    \n"
                    "#build rect W[,L] [<mat>]      \n"
                    "\n"
                    "#bu rect 20,15 fence:birch     \n"
                    "  20x15 animal pen made of     \n"
                    "  birch fence                  \n"
                    "\n"
                    "#bu rect 50                    \n"
                    "  50x50 rectangle, of whatever \n"
                    "  you are holding              \n" },

    { "wall"        "Wall                           \n"
                    "#build wall W,H [<mat>]        \n"
                    "\n"
                    "#bu wall 20,4 stonebrick:mossy \n"
                    "  20 wide, 4 high wall made of \n"
                    "  mossy stonebrick             \n" },

    { "disk"        "Horizontal disk                \n"
                    "#build disk D [<mat>] [-e]     \n"
                    "\n"
                    "#bu disk 15 stone              \n"
                    "  stone disk, 15 blocks across \n"
                    "\n"
                    "#bu disk 12.3                  \n"
                    "  diameter can be non-integer  \n"
                    "  best approximation is made   \n"
                    "\n"
                    "#bu disk 10 -e                 \n"
                    "  use -e option to get proper  \n"
                    "  disks of even size           \n" },

    { "ring"        "Horizontal ring - same as disk \n"
                    "but border only                \n"
                    "#build ring D [<mat>] [-e]     \n" },

    { "ball"        "Ball of specific diameter      \n"
                    "#build ball D [<mat>] [-e]     \n"
                    "\n"
                    "-e option works in similar way \n"
                    "create balls of even diameter  \n"
                    "correctly                      \n" },

    { "sphere"      "Hollow sphere of specific      \n"
                    "diameter - same as ball, just  \n"
                    "hollow                         \n"
                    "#build ball D [<mat>] [-e]     \n" },

    { "stairs"      "Stairs, optionally with base   \n"
                    "blocks for easier building     \n"
                    "#build stairs W,H [<mat>]      \n"
                    "                  [-n|m|f] [-e]\n"
                    "\n"
                    "#build stairs 3,10 stone_stairs\n"
                    "  3-wide, 10-high stairs made  \n"
                    "  cobblestone stairs blocks and\n"
                    "  with a single base block     \n"
                    "\n"
                    "-n : don't build any base      \n"
                    "-m : add only one base block   \n"
                    "     (just enough for placing) \n"
                    "-f : add base blocks over full \n"
                    "     width of the stairs       \n"
                    "-e : use exactly same building \n"
                    "    block for the base, instead\n"
                    "    of matching full block     \n" },
