...
const item_id ITEMS[] = {
    ...
    [0x10] = { "Coal ore" },
    [0x11] = { "Wood",                  I_MTYPE|I_MPOS|I_LOG,           // P: dir
               MNAMES_OLDWOOD },
    ...
    [0x15e] = { "Cooked Fish",          I_ITEM|I_MTYPE,
                { NULL, "Salmon", "Clownfish", "Pufferfish" }, },
    ...
    [0x19d] = { "Rabbit Stew",          I_ITEM|I_NSTACK },
