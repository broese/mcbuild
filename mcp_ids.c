...
const item_id ITEMS[] = {
    ...
    [0x2b] = { "Double Slab", I_MTYPE,
               { "Stone", "Sandstone", "Wood", "Cobble",
                 ...
                 [15] = "Tile Quartz", }, },
    [0x2c] = { "Stone Slab", I_MTYPE|I_MPOS,                    // P: U/D
    ...
    [0x34] = { "Spawner" },
    [0x35] = { "Wooden Stairs", I_MPOS },                       // P: dir
    ...
    [0x43] = { "Cobblestone Stairs", I_MPOS },                  // P: dir
    ...
    [0x6c] = { "Brick Stairs", I_MPOS },                        // P: dir
    [0x6d] = { "Stone Brick Stairs", I_MPOS },                  // P: dir
    [0x6e] = { "Mycelium" },
    [0x6f] = { "Lilypad", I_MPOS },

    [0x70] = { "Nether Brick" },
    [0x71] = { "Nether Brick Fence" },
    [0x72] = { "Nether Brick Stairs", I_MPOS },                 // P: dir
    ...
    [0x7e] = { "Wooden Slab", I_MTYPE|I_MPOS, MNAMES_OLDWOOD }, // P: up/down
    ...
    [0x85] = { "Emerald Block" },
    [0x86] = { "Spruce Stairs", I_MPOS },                       // P: dir
    [0x87] = { "Birch Stairs", I_MPOS },                        // P: dir
    [0x88] = { "Jungle Stairs", I_MPOS },                       // P: dir
    [0x89] = { "Command Block" },
    [0x8a] = { "Beacon" },
    ...
    [0x9c] = { "Quartz Stairs", I_MPOS },                       // P: dir
    ...
    [0xa3] = { "Acacia Stairs", I_MPOS },                       // P: dir
    [0xa4] = { "Dark Oak Stairs", I_MPOS },                     // P: dir
    [0xa5] = { "Slime Block" },
    [0xa6] = { "Barrier" },
    ...
    [0xb5] = { "Red Sandstone D-Slab", I_MTYPE,
               { [8]="Chiseled" }, },
    [0xb6] = { "Red Sandstone Slab", I_MPOS },                  // P: up/down
