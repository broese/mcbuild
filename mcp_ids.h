...
#define MNAMES_WOOD  { "Oak", "Spruce", "Birch", "Jungle",      \
                       "Acacia", "Dark Oak" }
#define MNAMES_COLOR { "White", "Orange", "Magenta", "LBlue",   \
                       "Yellow", "Lime", "Pink", "Grey",        \
                       "LGrey", "Cyan", "Purple", "Blue",       \
                       "Brown", "Green", "Red", "Black", }
#define MNAMES_MUSHR { "Pores only", "Cap NW", "Cap N", "Cap NE", \
                       "Cap W", "Cap T", "Cap E", "Cap SW",     \
                       "Cap S", "Cap SE", "Stem",               \
                       [14] = "Cap only", [15]="Stem only"}
#define MNAMES_SANDSTONE { NULL, "Chiseled", "Smooth" }
...
static const item_id ITEMS[] = {
    ...
    [0x03] = { "Dirt", I_MTYPE,
               { NULL, "Coarse", "Podzol" }, },
    [0x04] = { "Cobblestone" },
    [0x05] = { "Woodplanks", I_MTYPE, MNAMES_WOOD },
    [0x06] = { "Sapling", I_MTYPE, MNAMES_WOOD },
    [0x07] = { "Bedrock" },
    [0x08] = { "Waterflow" },
    [0x09] = { "Water" },
    [0x0a] = { "Lavaflow" },
    ...
    [0x18] = { "Sandstone", I_MTYPE, MNAMES_SANDSTONE },
    [0x19] = { "Noteblock" },
    [0x1a] = { "Bed", I_MPOS },
    ...
    [0x2c] = { "Stone Slab", I_MTYPE,
               { NULL, "Sandstone", "Stonewood", "Cobble",
                 "Brick", "Stone Brick", "Netherbrick", "Quartz",
                 "Stone U", "Sandstone U", "Stonewood U", "Cobble U",
                 "Brick U", "Stone Brick U", "Netherbrick U", "Quartz U", }, },
    [0x2d] = { "Brick" },
    [0x2e] = { "TNT" },
    [0x2f] = { "Bookshelf" },
    ...
    [0x4b] = { "Redstone Torch (off)", I_MPOS },
    [0x4c] = { "Redstone Torch (on)", I_MPOS },
    [0x4d] = { "Stone Button", I_MPOS },
    [0x4e] = { "Snow Layer" }, //TODO: wiki says it has a meta/dmg data
                               // in the inventory - check what it does
    [0x4f] = { "Ice" },
    ...
    [0x5c] = { "Cake", I_MSTATE },
    [0x5d] = { "Repeater (off)", I_MPOS },
    [0x5e] = { "Repeater (on)", I_MPOS },
    ...
    [0x63] = { "Brown Mushroom Block", I_MPOS, MNAMES_MUSHR },
    [0x64] = { "Red Mushroom Block", I_MPOS, MNAMES_MUSHR },
    [0x65] = { "Iron Bars" },
    [0x66] = { "Glass Pane" },
    [0x67] = { "Melon Block" },
    [0x68] = { "Pumpkin Stem" },
    ...
    [0x7e] = { "Wooden Slab", I_MTYPE|I_MPOS,
               { "Oak", "Spruce", "Birch", "Jungle",
                 ...
                 "Oak U", "Spruce U", "Birch U", "Jungle U",
                 "Acacia U", "Dark Oak U", NULL, NULL, }, },
    [0x7f] = { "Cocoa", I_MSTATE },
    ...
    [0x8d] = { "Carrot Plant", I_MSTATE },
    [0x8e] = { "Potato Plant", I_MSTATE },
    ...
    [0x93] = { "Pressure Plate (light)", I_MSTATE },
    [0x94] = { "Pressure Plate (heavy)", I_MSTATE },
    [0x95] = { "Comparator (off)", I_MPOS },
    [0x96] = { "Comparator (on)", I_MPOS },
    ...
    [0x9e] = { "Dropper", I_MPOS },
    [0x9f] = { "Hardened Clay", I_MTYPE, MNAMES_COLOR },
    ...
    [0xad] = { "Coal Block" },
    [0xae] = { "Packed Ice" },
    [0xaf] = { "Large Flower", I_MTYPE,
               { "Sunflower", "Lilac", "DblTallgrass", "Large Fern", 
                 "Rose Bush", "Peony", NULL, NULL, "Top" }, },

    [0xb0] = { "Standing Banner" },
    [0xb1] = { "Wall Banner" },
    [0xb2] = { "Inv. Daylight Sensor" },
    [0xb3] = { "Red Sandstone", I_MTYPE, MNAMES_SANDSTONE },
    [0xb4] = { "Red Sandstone Stairs", I_MPOS },
    [0xb5] = { "Red Sandstone D-Slab", I_MTYPE,
               { [8]="Chiseled" }, },
    [0xb6] = { "Red Sandstone Slab", I_MPOS },
    [0xb7] = { "Spruce Fence Gate", I_MPOS|I_MSTATE },
    [0xb8] = { "Birch Fence Gate", I_MPOS|I_MSTATE },
    [0xb9] = { "Jungle Fence Gate", I_MPOS|I_MSTATE },
    [0xba] = { "Dark Oak Fence Gate", I_MPOS|I_MSTATE },
    [0xbb] = { "Acacia Fence Gate", I_MPOS|I_MSTATE },
    [0xbc] = { "Spruce Fence" },
    [0xbd] = { "Birch Fence" },
    [0xbe] = { "Jungle Fence" },
    [0xbf] = { "Dark Oak Fence" },
    ...
    [0xc0] = { "Acacia Fence" },
    [0xc1] = { "Spruce Door", I_MPOS|I_MSTATE },
    [0xc2] = { "Birch Door", I_MPOS|I_MSTATE },
    [0xc3] = { "Jungle Door", I_MPOS|I_MSTATE },
    [0xc4] = { "Dark Oak Door", I_MPOS|I_MSTATE },
    [0xc5] = { "Acacia Door", I_MPOS|I_MSTATE },
