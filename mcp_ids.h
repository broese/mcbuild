...
#define SP_UnlockRecipes        SP(30)
#define SP_DestroyEntities      SP(31)
#define SP_RemoveEntityEffect   SP(32)
#define SP_ResourcePackSent     SP(33)
#define SP_Respawn              SP(34)
#define SP_EntityHeadLook       SP(35)
#define SP_SelectAdvancementTab SP(36)
#define SP_WorldBorder          SP(37)
#define SP_Camera               SP(38)
#define SP_HeldItemChange       SP(39)
#define SP_DisplayScoreboard    SP(3a)
#define SP_EntityMetadata       SP(3b)
#define SP_AttachEntity         SP(3c)
#define SP_EntityVelocity       SP(3d)
#define SP_EntityEquipment      SP(3e)
#define SP_SetExperience        SP(3f)
#define SP_UpdateHealth         SP(40)
#define SP_ScoreboardObjective  SP(41)
#define SP_SetPassengers        SP(42)
#define SP_Teams                SP(43)
#define SP_UpdateScore          SP(44)
#define SP_SpawnPosition        SP(45)
#define SP_TimeUpdate           SP(46)
#define SP_Title                SP(47)
#define SP_SoundEffect          SP(48)
#define SP_PlayerListHeader     SP(49)
#define SP_CollectItem          SP(4a)
#define SP_EntityTeleport       SP(4b)
#define SP_Advancements         SP(4c)
#define SP_EntityProperties     SP(4d)
#define SP_EntityEffect         SP(4e)
#define SP_UpdateSign           SP(80) // removed since 1.9.4
#define SP___                   SP(ff)

#define CP_TeleportConfirm      CP(00)
#define CP_PrepareCraftingGrid  CP(01)
#define CP_TabComplete          CP(02)
...
#define CP_UseEntity            CP(0b)
#define CP_KeepAlive            CP(0c)
#define CP_Player               CP(0d)
#define CP_PlayerPosition       CP(0e)
#define CP_PlayerPositionLook   CP(0f)
#define CP_PlayerLook           CP(10)
#define CP_VehicleMode          CP(11)
#define CP_SteerBoat            CP(12)
